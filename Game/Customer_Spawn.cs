...
public class Customer_Spawn : MonoBehaviour {
	...
	public int customer_MAX;
	public float time_cycle;
	...
	void Update () {
		...
		if(time() && customer_count < customer_MAX && Button.Item_list[0]) // && Button.exists // if item exists
		{
